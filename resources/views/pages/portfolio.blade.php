                    ...
                    <div class="image-grid">
                        @if($portfolioItems->count() > 0)
                            <div class="main-image rounded-4 overflow-hidden shadow-lg">
                                <img src="{{ $portfolioItems[0]->image_url }}"
        ...
        <div class="row g-4" id="portfolio-masonry">
                ...
                <div class="portfolio-card">
                    ...
                    <div class="portfolio-image-container">
                        ...
                        <div class="portfolio-overlay">
                            <div class="overlay-content">
                                ...
                                @endif
                                <a href="{{ route('portfolio.show', $item->slug) }}" class="btn btn-sm btn-pink mt-2 view-btn">
                    ...
                    <div class="portfolio-card-footer p-3">
                        <div class="d-flex justify-content-between align-items-center">
                            <a href="{{ route('portfolio.show', $item->slug) }}" class="text-decoration-none">
            ...
            <div class="col-12">
                <div class="empty-state text-center py-5">
                    ...
                    <a href="{{ route('services.index') }}" class="btn btn-outline-pink">
